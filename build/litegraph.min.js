...
$jscomp.defineProperty = $jscomp.ASSUME_ES5 || "function" == typeof Object.defineProperties ? Object.defineProperty : function(z, c, q) {
  z != Array.prototype && z != Object.prototype && (z[c] = q.value);
};
$jscomp.getGlobal = function(z) {
  return "undefined" != typeof window && window === z ? z : "undefined" != typeof global && null != global ? global : z;
};
$jscomp.global = $jscomp.getGlobal(this);
$jscomp.polyfill = function(z, c, q, l) {
  if (c) {
    q = $jscomp.global;
    z = z.split(".");
    ...
    l = q[z];
    c = c(l);
    c != l && null != c && $jscomp.defineProperty(q, z, {configurable:!0, writable:!0, value:c});
  }
};
$jscomp.polyfill("Object.is", function(z) {
  return z ? z : function(c, q) {
    return c === q ? 0 !== c || 1 / c === 1 / q : c !== c && q !== q;
  };
}, "es6", "es3");
$jscomp.polyfill("Array.prototype.includes", function(z) {
  return z ? z : function(c, q) {
    var l = this;
...
$jscomp.checkStringArgs = function(z, c, q) {
  if (null == z) {
...
$jscomp.polyfill("String.prototype.includes", function(z) {
  return z ? z : function(c, q) {
    return -1 !== $jscomp.checkStringArgs(this, c, "includes").indexOf(c, q || 0);
  };
}, "es6", "es3");
$jscomp.owns = function(z, c) {
  return Object.prototype.hasOwnProperty.call(z, c);
};
$jscomp.polyfill("Object.assign", function(z) {
  return z ? z : function(c, q) {
    for (var l = 1; l < arguments.length; l++) {
      var p = arguments[l];
      if (p) {
        for (var y in p) {
          $jscomp.owns(p, y) && (c[y] = p[y]);
        }
      }
    }
    return c;
...
$jscomp.Symbol = function() {
  var z = 0;
  return function(c) {
    return $jscomp.SYMBOL_PREFIX + (c || "") + z++;
  };
}();
$jscomp.initSymbolIterator = function() {
  ...
  "function" != typeof Array.prototype[z] && $jscomp.defineProperty(Array.prototype, z, {configurable:!0, writable:!0, value:function() {
...
$jscomp.arrayIterator = function(z) {
  ...
  return $jscomp.iteratorPrototype(function() {
    return c < z.length ? {done:!1, value:z[c++]} : {done:!0};
  });
};
...
$jscomp.iteratorFromArray = function(z, c) {
  $jscomp.initSymbolIterator();
  z instanceof String && (z += "");
  var q = 0, l = {next:function() {
    if (q < z.length) {
      var p = q++;
      return {value:c(p, z[p]), done:!1};
    }
    l.next = function() {
...
$jscomp.polyfill("Object.values", function(z) {
  return z ? z : function(c) {
    var q = [], l;
    for (l in c) {
...
$jscomp.polyfill("String.prototype.startsWith", function(z) {
  return z ? z : function(c, q) {
    var l = $jscomp.checkStringArgs(this, c, "startsWith");
    c += "";
    var p = l.length, y = c.length;
...
$jscomp.findInternal = function(z, c, q) {
  z instanceof String && (z = String(z));
  for (var l = z.length, p = 0; p < l; p++) {
    var y = z[p];
    if (c.call(q, y, p, z)) {
      return {i:p, v:y};
    }
...
$jscomp.polyfill("Array.prototype.findIndex", function(z) {
  return z ? z : function(c, q) {
...
(function(z) {
  ...
  z.LGraphCanvas = g.LGraphCanvas = h;
            ...
            if ((this.allow_interaction || f && f.flags.allow_interaction) && !this.read_only) {
              ...
              if (f) {
                ...
                if (this.connecting_node) {
                  if (this.connecting_output) {
                    if (e = this._highlight_input || [0, 0], !this.isOverNodeBox(f, a.canvasX, a.canvasY)) {
                      var n = this.isOverNodeInput(f, a.canvasX, a.canvasY, e);
                      if (-1 != n && f.inputs[n]) {
                        var c = f.inputs[n].type;
                        g.isValidConnection(this.connecting_output.type, c) && (this._highlight_input = e, this._highlight_input_slot = f.inputs[n]);
                      } else {
                        this._highlight_input_slot = this._highlight_input = null;
                      }
                    }
                  } else {
                    this.connecting_input && (e = this._highlight_output || [0, 0], this.isOverNodeBox(f, a.canvasX, a.canvasY) || (n = this.isOverNodeOutput(f, a.canvasX, a.canvasY, e), -1 != n && f.outputs[n] ? (c = f.outputs[n].type, g.isValidConnection(this.connecting_input.type, c) && (this._highlight_output = e)) : this._highlight_output = null));
                  }
                }
                ...
                for (b = 0; b < this.visible_links.length; ++b) {
                  if (n = this.visible_links[b], c = n._pos, !(!c || a.canvasX < c[0] - 4 || a.canvasX > c[0] + 4 || a.canvasY < c[1] - 4 || a.canvasY > c[1] + 4)) {
                    e = n;
                    break;
                  }
                }
  ...
  h.prototype.drawNodeShape = function(a, b, d, f, e, c, k) {
    b.strokeStyle = f;
    b.fillStyle = e;
    e = g.NODE_TITLE_HEIGHT;
    var n = 0.5 > this.ds.scale, v = a._shape || a.constructor.shape || g.ROUND_SHAPE, r = a.constructor.title_mode, w = !0;
    r == g.TRANSPARENT_TITLE || r == g.NO_TITLE ? w = !1 : r == g.AUTOHIDE_TITLE && k && (w = !0);
    x[0] = 0;
    x[1] = w ? -e : 0;
    x[2] = d[0] + 1;
    x[3] = w ? d[1] + e : d[1];
    k = b.globalAlpha;
    b.beginPath();
    v == g.BOX_SHAPE || n ? b.fillRect(x[0], x[1], x[2], x[3]) : v == g.ROUND_SHAPE || v == g.CARD_SHAPE ? b.roundRect(x[0], x[1], x[2], x[3], v == g.CARD_SHAPE ? [this.round_radius, this.round_radius, 0, 0] : [this.round_radius]) : v == g.CIRCLE_SHAPE && b.arc(0.5 * d[0], 0.5 * d[1], 0.5 * d[0], 0, 2 * Math.PI);
    b.fill();
    !a.flags.collapsed && w && (b.shadowColor = "transparent", b.fillStyle = "rgba(0,0,0,0.2)", b.fillRect(0, -1, x[2], 2));
    b.shadowColor = "transparent";
    ...
    if (w || r == g.TRANSPARENT_TITLE) {
      if (a.onDrawTitleBar) {
        ...
        if (r != g.TRANSPARENT_TITLE && (a.constructor.title_color || this.render_title_colored)) {
          ...
          b.beginPath();
          v == g.BOX_SHAPE || n ? b.rect(0, -e, d[0] + 1, e) : (v == g.ROUND_SHAPE || v == g.CARD_SHAPE) && b.roundRect(0, -e, d[0] + 1, e, a.flags.collapsed ? [this.round_radius] : [this.round_radius, this.round_radius, 0, 0]);
          b.fill();
          b.shadowColor = "transparent";
        }
      }
      ...
      !n && (b.font = this.title_text_font, k = String(a.getTitle())) && (b.fillStyle = c ? g.NODE_SELECTED_TITLE_COLOR : a.constructor.title_text_color || this.node_title_color, a.flags.collapsed ? (b.textAlign = "left", b.measureText(k), b.fillText(k.substr(0, 20), e, g.NODE_TITLE_TEXT_Y - e), b.textAlign = "left") : (b.textAlign = "left", b.fillText(k, e, g.NODE_TITLE_TEXT_Y - e)));
      a.flags.collapsed || !a.subgraph || a.skip_subgraph_button || (k = g.NODE_TITLE_HEIGHT, w = a.size[0] - k, u = g.isInsideRectangle(this.graph_mouse[0] - a.pos[0], this.graph_mouse[1] - a.pos[1], w + 2, -k + 2, k - 4, k - 4), b.fillStyle = u ? "#888" : "#555", v == g.BOX_SHAPE || n ? b.fillRect(w + 2, -k + 2, k - 4, k - 4) : (b.beginPath(), b.roundRect(w + 2, -k + 2, k - 4, k - 4, [4]), b.fill()), b.fillStyle = "#333", b.beginPath(), b.moveTo(w + 0.2 * k, 0.6 * -k), b.lineTo(w + 0.8 * k, 0.6 * 
    ...
    if (c) {
      ...
      r == g.TRANSPARENT_TITLE && (x[1] -= e, x[3] += e);
      b.lineWidth = 1;
      b.globalAlpha = 0.8;
      b.beginPath();
      v == g.BOX_SHAPE ? b.rect(-6 + x[0], -6 + x[1], 12 + x[2], 12 + x[3]) : v == g.ROUND_SHAPE || v == g.CARD_SHAPE && a.flags.collapsed ? b.roundRect(-6 + x[0], -6 + x[1], 12 + x[2], 12 + x[3], [2 * this.round_radius]) : v == g.CARD_SHAPE ? b.roundRect(-6 + x[0], -6 + x[1], 12 + x[2], 12 + x[3], [2 * this.round_radius, 2, 2 * this.round_radius, 2]) : v == g.CIRCLE_SHAPE && b.arc(0.5 * d[0], 0.5 * d[1], 0.5 * d[0] + 6, 0, 2 * Math.PI);
  ...
  h.prototype.renderLink = function(a, b, d, f, e, c, k, m, t, r) {
    ...
    for (var v = 0; v < r; v += 1) {
      ...
      if (this.links_render_mode == g.SPLINE_LINK) {
        ...
        a.bezierCurveTo(b[0] + l, b[1] + p + E, d[0] + K, d[1] + C + E, d[0], d[1] + E);
      } else {
        if (this.links_render_mode == g.LINEAR_LINK) {
          ...
          a.lineTo(b[0] + 15 * l, b[1] + 15 * p + E);
          a.lineTo(d[0] + 15 * K, d[1] + 15 * C + E);
          a.lineTo(d[0], d[1] + E);
        } else {
          if (this.links_render_mode == g.STRAIGHT_LINK) {
            a.moveTo(b[0], b[1]), E = b[0], l = b[1], p = d[0], K = d[1], m == g.RIGHT ? E += 10 : l += 10, t == g.LEFT ? p -= 10 : K -= 10, a.lineTo(E, l), a.lineTo(0.5 * (E + p), l), a.lineTo(0.5 * (E + p), K), a.lineTo(p, K), a.lineTo(d[0], d[1]);
          } else {
            return;
          }
        }
    ...
    for (var t = g.WIDGET_OUTLINE_COLOR, r = g.WIDGET_BGCOLOR, w = g.WIDGET_TEXT_COLOR, u = g.WIDGET_SECONDARY_TEXT_COLOR, E = 0; E < c.length; ++E) {
      ...
      switch(h.type) {
        ...
        case "combo":
          ...
          3), p - 30 - 20, l + 0.7 * k) : (q = h.value, h.options.values && (y = h.options.values, y.constructor === Function && (y = y()), y && y.constructor !== Array && (q = y[h.value])), d.fillText(q, p - 30 - 20, l + 0.7 * k)));
          break;
        case "string":
        case "text":
          d.textAlign = "left";
  ...
  h.prototype.processNodeWidgets = function(a, b, d, f) {
    function e(e, f) {
      ...
      e.callback && e.callback(e.value, t, a, b, d);
    }
    if (!a.widgets || !a.widgets.length || !this.allow_interaction && !a.flags.allow_interaction) {
      return null;
    }
    for (var c = b[0] - a.pos[0], k = b[1] - a.pos[1], m = a.size[0], t = this, r = this.getCanvasWindow(), h = 0; h < a.widgets.length; ++h) {
      var u = a.widgets[h];
      if (u && !u.disabled) {
                ...
                if (d.type == g.pointerevents_method + "down") {
                  ...
                  if ("number" == u.type) {
                    ...
                    if (c) {
                      ...
                      var y = p != q ? Object.values(p) : p;
                      new g.ContextMenu(y, {scale:Math.max(1, this.ds.scale), event:d, className:"dark", callback:function(a, b, d) {
                        p != q && (a = y.indexOf(a));
                        this.value = a;
                        e(this, a);
                        t.dirty_canvas = !0;
  ...
  h.prototype.showSearchBox = function(a, b) {
    ...
    function f(a) {
      ...
      x ? (x = a ? x.nextSibling : x.previousSibling) || (x = b) : x = a ? p.childNodes[0] : p.childNodes[p.childNodes.length];
    ...
    c.search_box = r;
    var p = r.querySelector(".helper"), q = null, y = null, x = null, B = r.querySelector("input");
    ...
    if (b.do_type_filter) {
      if (w) {
        ...
        for (var z = 0; z < D; z++) {
          ...
          A.innerHTML = F[z];
          w.appendChild(A);
          !1 !== b.type_filter_in && (b.type_filter_in + "").toLowerCase() == (F[z] + "").toLowerCase() && (A.selected = !0);
        }
      ...
      if (u) {
        ...
        for (z = 0; z < D; z++) {
          A = document.createElement("option"), A.value = F[z], A.innerHTML = F[z], u.appendChild(A), !1 !== b.type_filter_out && (b.type_filter_out + "").toLowerCase() == (F[z] + "").toLowerCase() && (A.selected = !0);
        }
...
(function(z) {
  ...
  C.registerNodeType("basic/const", y);
  ...
  C.registerNodeType("basic/object_property", x);
  L.title = "Object keys";
    ...
    if (typeof a == typeof b) {
      switch(this.properties.OP) {
        ...
        case "!=":
          ...
          switch(typeof a) {
            case "object":
              var e = Object.getOwnPropertyNames(a), f = Object.getOwnPropertyNames(b);
...
(function(z) {
  ...
  y.prototype.onAction = function(c, g, h) {
...
(function(z) {
  ...
  G.registerNodeType("widget/knob", y);
...
(function(z) {
  ...
  u.registerNodeType("math/rand", y);
  h.title = "Noise";
  ...
  u.registerNodeType("math/gate", x);
  L.title = "Average";
...
(function(z) {
  ...
  A.registerNodeType("logic/NOT", y);
  h.title = "bool == bool";
...
(function(z) {
  ...
  var J = z.LiteGraph, Z = z.LGraphCanvas;
  z.LGraphTexture = null;
      ...
      if (this.properties.precision === c.PASS_THROUGH) {
        ...
        if (this.properties.uvcode || this.properties.pixelcode) {
          ...
          if (!(this.has_error || k && this._shader_code == f + "|" + g)) {
            var m = c.replaceCode(p.pixel_shader, {UV_CODE:f, PIXEL_CODE:g});
            try {
          ...
          if (this._shader) {
            ...
            this._tex.drawTo(function() {
              ...
              k.uniforms({u_texture:0, u_textureB:1, value:h, texSize:[d, e, 1 / d, 1 / e], time:t}).draw(c);
            });
  ...
  }, J.registerNodeType("texture/operation", p), y.title = "Shader", y.desc = "Texture shader", y.widgets_info = {code:{type:"code", lang:"glsl"}, precision:{widget:"combo", values:c.MODE_VALUES}}, y.prototype.onPropertyChanged = function(a, b) {
  ...
  }, y.pixel_shader = "precision highp float;\n\nvarying vec2 v_coord;\nuniform float time; //time in seconds\nuniform vec4 texSize; //tex resolution\nuniform float u_value;\nuniform vec4 u_color;\n\nvoid main() {\n\tvec2 uv = v_coord;\n\tvec3 color = vec3(0.0);\n\t//your code here\n\tcolor.xy=uv;\n\n\tgl_FragColor = vec4(color, 1.0);\n}\n", J.registerNodeType("texture/shader", y), h.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}}, h.title = "Scale/Offset", h.desc = "Applies an scaling and offseting", 
  h.prototype.onExecute = function() {
    var a = this.getInputData(0);
  ...
  J.registerNodeType("texture/linear_avg_smooth", F), x.title = "Image to Texture", x.desc = "Uploads an image to the GPU", x.prototype.onExecute = function() {
    var a = this.getInputData(0);
    if (a) {
  ...
  }, J.registerNodeType("texture/imageToTexture", x), L.widgets_info = {texture:{widget:"texture"}, precision:{widget:"combo", values:c.MODE_VALUES}}, L.title = "LUT", L.desc = "Apply LUT to Texture", L.prototype.onExecute = function() {
    if (this.isOutputConnected(0)) {
      var a = this.getInputData(0);
  ...
  J.registerNodeType("texture/kuwahara", r), w.title = "XDoG Filter", w.desc = "Filters a texture giving an artistic ink style", w.max_radius = 10, w._shaders = [], w.prototype.onExecute = function() {
    ...
    if (a && this.isOutputConnected(0)) {
      ...
      var d = w._xdog_shader, c = GL.Mesh.getScreenQuad(), e = this.properties.sigma, f = this.properties.k, g = this.properties.p, k = this.properties.epsilon, m = this.properties.phi;
      a.bind(0);
      this._temp_texture.drawTo(function() {
        d.uniforms({src:0, sigma:e, k:f, p:g, epsilon:k, phi:m, cvsWidth:a.width, cvsHeight:a.height}).draw(c);
      });
      this.setOutputData(0, this._temp_texture);
    }
  ...
  J.registerNodeType("texture/tonemapping", N), Q.title = "Perlin", Q.desc = "Generates a perlin noise texture", Q.widgets_info = {precision:{widget:"combo", values:c.MODE_VALUES}, width:{type:"number", precision:0, step:1}, height:{type:"number", precision:0, step:1}, octaves:{type:"number", precision:0, step:1, min:1, max:50}}, Q.prototype.onGetInputs = function() {
    ...
    if (this.isOutputConnected(0)) {
      ...
      var f = this.getInputOrProperty("persistence"), g = this.getInputOrProperty("octaves"), k = this.getInputOrProperty("offset"), m = this.getInputOrProperty("scale"), h = this.getInputOrProperty("amplitude"), t = this.getInputOrProperty("seed");
      d = "" + a + b + d + f + g + m + t + k[0] + k[1] + h;
      if (d != this._key) {
        this._key = d;
        var l = this._uniforms;
        l.u_persistence = f;
  ...
  b) {
    ...
    var g = this.getInputData(0), k = this.properties, m = this, h = this.graph.getTime(), t = gl, l = gl.canvas;
    if (this.properties.use_html_canvas || !z.enableWebGLCanvas) {
    ...
    if (t == gl) {
      e.drawTo(function() {
        ...
        try {
          a.draw ? a.draw.call(m, l, t, h, a, g) : a.call(m, l, t, h, a, g), m.boxcolor = "#00FF00";
        } catch (U) {
      ...
      try {
        a.draw ? a.draw.call(this, l, t, h, a, g) : a.call(this, l, t, h, a, g), this.boxcolor = "#00FF00";
      } catch (U) {
...
(function(z) {
  var c = z.LiteGraph, q = z.LGraphTexture;
  if ("undefined" != typeof GL) {
    ...
    h.prototype.onExecute = function() {
      ...
      if (this.properties.precision === q.PASS_THROUGH) {
        ...
        if (c) {
          ...
          gl.disable(gl.BLEND);
          gl.disable(gl.DEPTH_TEST);
          var z = Mesh.getScreenQuad(), g = h._shader;
          this._tex.drawTo(function() {
            c.bind(0);
            g.uniforms({u_texture:0, u_aberration:l, u_distortion:p, u_blur:y}).draw(z);
          });
          this.setOutputData(0, this._tex);
        }
      }
    ...
    y.prototype.onExecute = function() {
      ...
      if (c && l && this.properties.shape) {
        ...
        if (p) {
          var z = this.properties.threshold;
          this.isInputConnected(3) && (z = this.getInputData(3), this.properties.threshold = z);
          ...
          this._temp_texture.drawTo(function() {
            ...
            c.bind(0);
            p.bind(3);
            F.uniforms({u_texture:0, u_mask:2, u_shape:3, u_alpha:m, u_threshold:z, u_pointSize:t, u_itexsize:[1.0 / c.width, 1.0 / c.height]}).draw(x, gl.POINTS);
          });
          this.setOutputData(0, this._temp_texture);
        }
      } else {
    ...
    y.prototype.createPointsMesh = function(c, h, l) {
      for (var p = Math.round(c / l), q = Math.round(h / l), g = new Float32Array(p * q * 2), y = -1, z = 2 / c * l, x = 2 / h * l, A = 0; A < q; ++A) {
      ...
      if (this.isOutputConnected(0)) {
        ...
        if (this.properties.precision === q.PASS_THROUGH) {
          ...
          if (c) {
            ...
            var y = this.properties.fx, G = p.shaders[y];
            if (!G) {
              var g = p["pixel_shader_" + y];
              if (!g) {
                return;
              }
              G = p.shaders[y] = new GL.Shader(Shader.SCREEN_VERTEX_SHADER, g);
            }
            gl.disable(gl.BLEND);
            gl.disable(gl.DEPTH_TEST);
            var B = Mesh.getScreenQuad();
            var F = z.LS && LS.Renderer._current_camera ? [LS.Renderer._current_camera.near, LS.Renderer._current_camera.far] : [1, 100];
            var x = null;
            "noise" == y && (x = q.getNoiseTexture());
            this._tex.drawTo(function() {
              c.bind(0);
              "noise" == y && x.bind(1);
    ...
    l.prototype.onExecute = function() {
      ...
      if (this.properties.precision === q.PASS_THROUGH) {
        ...
        if (c) {
          ...
          gl.disable(gl.BLEND);
          gl.disable(gl.DEPTH_TEST);
          var p = Mesh.getScreenQuad(), y = l._shader, z = this.properties.invert;
          this._tex.drawTo(function() {
            c.bind(0);
            y.uniforms({u_texture:0, u_intensity:h, u_isize:[1 / c.width, 1 / c.height], u_invert:z ? 1 : 0}).draw(p);
          });
          this.setOutputData(0, this._tex);
        }
      }
...
(function(z) {
  ...
  x.registerNodeType("midi/input", l);
  p.MIDIInterface = q;
  p.title = "MIDI Output";
  ...
  x.registerNodeType("midi/output", p);
  y.title = "MIDI Show";
  ...
  y.prototype.onAction = function(g, h) {
  ...
  x.registerNodeType("midi/show", y);
  h.title = "MIDI Filter";
  ...
  x.registerNodeType("midi/filter", h);
  H.title = "MIDIEvent";
  ...
  x.registerNodeType("midi/event", H);
  A.title = "MIDICC";
  ...
  D.processScale = function(g) {
    ...
    for (var h = 0; h < g.length; ++h) {
      var k = g[h];
      g[h] = 2 == k.length && "#" != k[1] || 2 < k.length ? -x.MIDIEvent.NoteStringToPitch(k) : c.note_to_index[k] || 0;
    }
    return g;
  };
  ...
  x.registerNodeType("midi/transpose", I);
  ...
  x.registerNodeType("midi/quantize", G);
  ...
  x.registerNodeType("midi/fromFile", g);
  B.title = "MIDI Play";
  ...
  x.registerNodeType("midi/play", B);
  F.title = "MIDI Keys";
  ...
  x.registerNodeType("midi/keys", F);
})(this);
(function(z) {
  function c() {
  ...
  t.registerNodeType("audio/convolver", y);
  ...
  x.prototype.processCode = function() {
    try {
      ...
      console.error("Error in onaudioprocess code", k), this._callback = x._bypass_function, this.audionode.onaudioprocess = this._callback;
    }
  };
  ...
  t.registerNodeType("audio/script", x);
  L.title = "Destination";
  L.desc = "Audio output";
  ...
  c.prototype.onExecute = function() {
    ...
    if (this._ws && this._ws.readyState == WebSocket.OPEN) {
      for (var c = this.properties.room, l = this.properties.only_send_changes, h = 1; h < this.inputs.length; ++h) {
        ...
        if (null != q) {
          try {
            var z = JSON.stringify({type:0, room:c, channel:h, data:q});
          } catch (D) {
            continue;
          }
          l && this._last_sent_data[h] == z || (this._last_sent_data[h] = z, this._ws.send(z));
        }
      }
